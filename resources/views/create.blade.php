...
<body>
    ...
    <form action="{{route('store')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" required class="form-control" name="kode" aria-describedby="emailHelp">
        ...
        <div class="form-group">
            ...
            <select class="form-select" required aria-label="Default select example" name="tipe">
